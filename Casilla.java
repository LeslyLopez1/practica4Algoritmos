...
public class Casilla implements Comparable<Casilla> {
    ...
    public boolean concuerdaCon(Casilla otra) { return this.compareTo(otra) == 0; }
    ...
    public void eliminar()  { nodo.delete(); eliminada = true; }
    
    public void restaurar() { eliminada = false; }
